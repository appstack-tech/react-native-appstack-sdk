...
- **Android:** Updated the native Appstack Android SDK dependency to `1.11.0-SNAPSHOT`, which adds `com.google.android.gms:play-services-appset` as a transitive dependency.
